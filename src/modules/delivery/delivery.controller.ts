...
@ApiTags('Delivery')
@Controller('api/v1/delivery/governorates')
export class DeliveryController {
  ...
  async findById(@Param('id', ParseUUIDPipe) id: string): Promise<HandlerResult<Governorate>> {
  ...
  async create(@Body() dto: CreateGovernorateDto): Promise<HandlerResult<Governorate>> {
